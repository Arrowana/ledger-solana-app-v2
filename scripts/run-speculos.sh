...
APP_ELF_HOST="${LEDGER_APP_ELF:-$ROOT_DIR/target/$LEDGER_DEVICE/release/$APP_BIN}"
APP_ELF_CONTAINER="${LEDGER_APP_ELF_CONTAINER:-/app/target/$LEDGER_DEVICE/release/$APP_BIN}"
